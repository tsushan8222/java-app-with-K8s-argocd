...
# Branch creation for webdev
        ...
        curl --silent --request POST --header "PRIVATE-TOKEN: $GITLAB_PRIVATE_TOKEN" "https://gitlab-ce.example-shared.dev.com/api/v4/projects/$CI_PROJECT_ID/repository/branches?branch=feature/${CI_PIPELINE_ID}-${CI_JOB_ID}&ref=$TARGET_BRANCH"
        ...
        --data "{\"id\": ${CI_PROJECT_ID},
                ...
                \"title\": \"Merge branch feature/${CI_PIPELINE_ID}-${CI_JOB_ID} into develop\",
